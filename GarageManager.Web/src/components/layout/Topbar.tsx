      ...
      <div className="flex items-center justify-between gap-4 px-5 py-4 lg:px-8">
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          ...
          <div className="relative hidden md:block">
            ...
            <input type="text" placeholder="Search..." className="h-10 w-56 rounded-xl border border-ink-700 bg-ink-800/70 pl-9 pr-3 text-sm text-ink-100 placeholder-ink-400 transition focus:border-flame-500 focus:outline-none focus:ring-2 focus:ring-flame-500/20" />
          </div>
