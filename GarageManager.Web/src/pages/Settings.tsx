        ...
        <div className="space-y-4 p-5">
          ...
          <div className="rounded-xl border border-ink-700/50 bg-ink-800/40 p-4">
            ...
            <div className="mt-2 grid gap-1.5 font-mono text-xs text-ink-300">
              <p><span className="text-sky-400">POST</span> /api/auth/login</p>
              <p><span className="text-sky-400">GET</span> /api/session/me</p>
              ...
              <p><span className="text-amber-400">PATCH</span> /api/customers/{'{id}'}/deactivate</p>
              ...
              <p><span className="text-amber-400">PATCH</span> /api/Vehicle/{'{id}'}/deactivate</p>
